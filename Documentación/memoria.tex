...
\todo{Falta completar el abstract.}
\end{abstract}
...
\todo{No estoy muy seguro de si las referencias cruzadas deberíamos cambiarlas a números o no, da una sensación bastante mala cuando hay dos referencias juntas.}
