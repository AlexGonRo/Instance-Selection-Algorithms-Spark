 ...
 \begin{table}
  \begin{center}
   \begin{tabular}{|>{\cellcolor[gray]{0.8}} L{3cm} | L{9cm} |}
    ...
    \hline
    Acciones & 
    1. El usuario completa los campos comunes para todas las configuraciones de Spark \newline
    2. El usuario presiona un botón para añadir una nueva configuración de Spark. \newline
    			   3. La aplicación muestra un nuevo diálogo. \newline
    			   4. El usuario rellena todos los campos mostrados en el nuevo diálogo. \newline
  ...
  \begin{center}
   \begin{tabular}{|>{\cellcolor[gray]{0.8}} L{3cm} | L{9cm} |}
    ...
    2. La aplicación muestra un nuevo diálogo. \newline
    			   3. El usuario selecciona el botón para buscar en los archivos del sistema el fichero deseado. Alternativamente, puede escribirlo manualmente. \newline
    			   4. El usuario cumplimenta, si lo ve necesario, todos los campos restantes mostrados en el diálogo. \newline
    			   5. El usuario presiona un botón para aceptar la nueva configuración. \\
    \hline
