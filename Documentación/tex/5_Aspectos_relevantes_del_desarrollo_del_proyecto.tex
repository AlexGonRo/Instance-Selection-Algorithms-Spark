...
En el siguiente ejemplo (\ref{lst:cvScala}), mostramos un fragmento con el código que genera un conjunto de pares entrenamient-test y realiza sobre cada uno de ellos una operación cualquiera:
