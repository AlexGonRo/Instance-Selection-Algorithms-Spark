...
\todo{Patrones de diseño de la interfaz}
%¿Patrón de diseño adaptador en algún sitio de la interfaz?
%Patrón de diseño ``composite''(compuesto) en la interfaz gráfica
%Patrón de diseño ``Fachada'' al lanzar las ejecuciones? Un poco forzado lo veo yo
%Patrón ``comando'' cuando convertimos aciones en objetos (interfaz con los action)
%Patrón de diseño estado en la interfaz gráfica, cuando no se hace nada si hay algo ejecutandose(con un if else)
