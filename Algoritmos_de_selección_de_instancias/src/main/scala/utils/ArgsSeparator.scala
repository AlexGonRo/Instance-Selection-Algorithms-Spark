...
/**
 * Conjunto de divisores que, en un comando de ejecución, marcan el principio de
 * los argumentos para un determinado elemento del programa.
 *
...
object ArgsSeparator extends Enumeration {
  ...
  final val READER_SEPARATOR = Value("-r")
    /**
   * Indica el inicio de los valores destinados al filtro o selector de instancias.
   */
